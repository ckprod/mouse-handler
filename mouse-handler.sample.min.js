...
var i={}
for(var s in this.options)i[s]=void 0===n[s]?this.options[s]:n[s]
...
return Math.sqrt(o*o+i*i)>=this.options.distance}function p(){}function m(){}function h(){}function f(){}function d(){}return{constructor:t,options:{distance:0},_mouseDown:a,_mouseMove:u,_mouseUp:l,_mouseDistanceMet:c,_mousePrepareClick:p,_mousePrepareDrag:m,_mouseDrag:h,_mouseExecuteClick:f,_mouseStopDrag:d}}(),function(){function o(t){var e=t.pageX
if(void 0===e){var o=document.body,n=document.documentElement
...
this._mouseDownEvent=h}var d=n(this.dragArea),g=document.getElementById("canvas")
